...
export default function ViewPurchaseModal({ isOpen, procurementId, onClose, vendors }: ViewPurchaseModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 md:p-8">
      <div className={`bg-[#232b3e] border border-gray-700 shadow-2xl flex flex-col overflow-hidden relative transition-all duration-300 ${
        isMaximized ? 'w-full h-full fixed inset-0 m-0 rounded-none' : 'w-[1000px] max-w-[95vw] h-[80vh] max-h-[90vh] rounded-xl'
      }`}>
        ...
        <div className="px-6 py-4 border-b border-gray-700 flex justify-between items-center bg-[#293653] shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded font-medium text-[12px] transition-colors shadow-sm"
            >
              Mark as complete
            </button>
        ...
        <div className="px-6 py-4 border-t border-gray-700 bg-[#1b202c] shrink-0 flex justify-end items-center gap-3">
           ...
           <button 
             ...
             className="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded font-medium text-[13px] transition-colors shadow-sm flex items-center gap-2 focus:outline-none"
           >
             Update
           </button>
        </div>
