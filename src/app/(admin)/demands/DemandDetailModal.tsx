import { X, Maximize2, Minimize2, ClipboardList, Settings, Loader2, Trash2, Lock, Eye, Check } from 'lucide-react';
            ...
            <table className="w-full text-[12px] text-left">
              <thead className="text-[12px] text-gray-900 font-bold uppercase bg-[#cdd5df]">
                <tr>
                  ...
                  <th className="px-4 py-3 border-r border-[#bac4cf] text-center w-20">VIEW</th>
